    ...
    <section className="py-14 bg-white">
      <div className="max-w-[1280px] mx-auto px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
          {promos.map((promo, i) => (
            <div key={i} className="flex flex-col rounded-2xl overflow-hidden group cursor-pointer" style={{ backgroundColor: promo.bgColor }}>
              ...
              <div className="relative w-full h-48 mt-4 transform group-hover:scale-105 transition-transform duration-300">
                <Image
                  src={promo.image}
                  alt={`Save ${promo.save}`}
                  fill
