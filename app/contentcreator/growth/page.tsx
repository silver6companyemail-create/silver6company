...
export default function CreatorGrowthTracker() {
    ...
    // Script & Hook platform breakdown
    ...
    // Dynamic achievement checker adapted to content creator metrics
    const achievements = [
        {
            id: 'first-upload',
            title: 'The Wordsmith',
            desc: 'Compose and submit your first script concept to the vault.',
            requirement: 'Draft at least 1 script',
            icon: Sparkles,
        ...
        {
            id: 'trio-creator',
            title: 'Trilogy Scriptwriter',
            desc: 'Successfully draft a trilogy of finalized script concepts.',
            requirement: 'Draft 3 script vault items',
            icon: Flame,
        ...
        },
        {
            ...
            title: 'High Hook Accuracy',
            desc: 'Deliver a high-priority storyboard script under a strict deadline.',
            requirement: 'Complete 1 High Priority script',
            icon: Target,
        ...
        },
        {
            id: 'master-editor',
            title: 'Viral Engine',
            desc: 'Assemble an impressive archive of completed pre-production assets.',
            requirement: 'Complete 5 story/script tasks',
            icon: Award,
    ...
    if (loading) {
        return (
            <div className="h-96 flex flex-col items-center justify-center gap-3">
                ...
                <span className="text-xs text-gray-400 font-extrabold tracking-wider">Compiling creator statistics...</span>
            </div>
        )
    }
        ...
        <div className="space-y-8 animate-in fade-in duration-300">
            ...
            <div className="bg-gradient-to-br from-slate-900 via-emerald-950 to-teal-950 p-8 rounded-3xl text-white shadow-xl flex flex-col md:flex-row md:items-center md:justify-between gap-6 border border-emerald-500/20 relative overflow-hidden group">
                ...
                <div className="space-y-2 relative z-10">
                    ...
                    <h2 className="text-2xl md:text-3xl font-extrabold">Creator Growth & Impact</h2>
                    <p className="text-slate-200/85 text-sm max-w-xl leading-relaxed">
                        Track your concept drafting turnaround times, monitor publish accuracy across social platform integrations, and view milestone badges unlocked.
                    </p>
                </div>
                <div className="shrink-0 flex items-center gap-4 bg-white/5 p-4 rounded-xl border border-white/10 relative z-10">
                    ...
                    <div>
                        <p className="text-xs font-bold text-slate-400">Total Scripts</p>
                        <p className="text-sm font-extrabold text-white">Drafts Delivered</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white/85 backdrop-blur-md p-6 rounded-2xl border border-slate-200/60 shadow-sm flex flex-col justify-between items-center text-center hover:shadow-md transition-all duration-300">
                    <div className="w-full flex justify-between items-center mb-4">
                        <span className="text-xs font-extrabold text-slate-450 uppercase tracking-widest">Script Pitch Tempo</span>
                    ...
                    <div className="mt-4 space-y-1">
                        <h4 className="font-extrabold text-slate-800 text-sm">
                            {completedCount >= 5 ? 'Elite Pitch Speed' : completedCount >= 2 ? 'Optimal Drafting' : 'Initializing Pace'}
                        </h4>
                        <p className="text-xs text-slate-500 max-w-xs">Average time from initial concept outline to finalized script vault submission.</p>
                    </div>
                </div>

                {/* 2. Schedule Publish Precision */}
                <div className="bg-white/85 backdrop-blur-md p-6 rounded-2xl border border-slate-200/60 shadow-sm flex flex-col justify-between items-center text-center hover:shadow-md transition-all duration-300">
                    <div className="w-full flex justify-between items-center mb-4">
                        <span className="text-xs font-extrabold text-slate-450 uppercase tracking-widest">Schedule Publish Precision</span>
                    ...
                    <div className="relative w-36 h-36 flex items-center justify-center">
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                            ...
                            <span className="text-[9px] font-extrabold text-slate-400 uppercase tracking-wider">On-Time Accuracy</span>
                        </div>
                    </div>

                    <div className="mt-4 space-y-1">
                        <h4 className="font-extrabold text-slate-800 text-sm">Publish Calendars Met</h4>
                        <p className="text-xs text-slate-500 max-w-xs">Percentage of scripted campaigns successfully published exactly on scheduled dates.</p>
                    </div>
                </div>

                {/* 3. Platform Distribution Split */}
                <div className="bg-white/85 backdrop-blur-md p-6 rounded-2xl border border-slate-200/60 shadow-sm flex flex-col justify-between hover:shadow-md transition-all duration-300">
                    <div className="flex justify-between items-center mb-6">
                        <span className="text-xs font-extrabold text-slate-450 uppercase tracking-widest">Platform Distribution</span>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="space-y-1.5">
                            <div className="flex justify-between text-xs font-bold text-slate-700">
                                ...
                                <span>{videoCompleted} Campaigns</span>
                            </div>
                        ...
                        <div className="space-y-1.5">
                            <div className="flex justify-between text-xs font-bold text-slate-700">
                                ...
                                <span>{graphicCompleted} Campaigns</span>
                            </div>
                            <div className="w-full bg-slate-100 h-2.5 rounded-full overflow-hidden">
                                <div 
                    ...
                    <div className="mt-6 pt-4 border-t border-slate-100 flex justify-between items-center text-xs">
                        <span className="text-slate-450 font-bold">Concept Pipeline Drafts:</span>
                        <span className="text-slate-800 font-extrabold">{totalCount - completedCount} Scripts Left</span>
                    </div>
                </div>
            </div>
