                  ...
                  return (
                    <div 
                      ...
                      className={`flex items-center justify-between p-4 rounded-xl border-2 transition-all ${
                        isDisabled ? 'opacity-70 cursor-not-allowed' : 'cursor-pointer hover:shadow-sm'
                      } ${
                        hasAccess 
                    ...
                    >
                      ...
                      <div className={`w-6 h-6 rounded-md flex items-center justify-center transition-colors ${
                        hasAccess ? 'bg-[#2db34a] text-white' : 'bg-gray-100 text-transparent border border-gray-300'
                      }`}>
